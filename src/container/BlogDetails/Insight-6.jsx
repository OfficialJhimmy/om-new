...
import blogimage from "../../assets/images/blog-4 big.jpeg";
    ...
    <>
      ...
      <div className="insight-single__container">
        ...
        <div className="insight-single__middle">
          <h3>Personality</h3>
          <h2>Who is setting the pace for personal sustainability?</h2>
          <p>
            ...
            a time. Then something erupts onto the scene—a new technology,a
            ...
            What did Oracle do with all that agility? When we examine the way
        ...
        <div className="insight-single__bottom">
          <Button title="Next" icon={next} url="/insights" />
        </div>
      </div>
      <Footer />
    </>
